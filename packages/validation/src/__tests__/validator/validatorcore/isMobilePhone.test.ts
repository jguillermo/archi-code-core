...
describe('Validators', () => {
  it('should validate mobile phone number', () => {
    const fixtures = [
      ...
      {
        locale: 'ar-OM',
        valid: ['+96891212121', '+96871212121', '0096899999999', '93112211', '99099009'],
        invalid: [
          '+96890212121',
          '0096890999999',
          '0090999999',
      ...
      },
      {
        ...
        invalid: ['+26612345678', '', '2664512-21', '+2662212345678', 'someString'],
      },
      {
        locale: 'en-BM',
      ...
      },
      {
        ...
        invalid: ['999', '+876102123422', '+8861021234', '8761021212213', '876102123'],
      },
      {
        locale: 'en-KE',
        valid: [
      ...
      },
      {
        ...
        invalid: ['58563', '+2658256258', '0896328741', '0708574896', '+26570857489635'],
      },
      {
        locale: 'es-PE',
        valid: [
      ...
      },
      {
        ...
        invalid: ['0612457892', '01122921737346', '+22762457898', '+226724578980', '+22634523'],
      },
      {
        locale: 'fr-CA',
      ...
      },
      {
        ...
        invalid: ['243', '+254818590432', '+24389032', '123456789', '+243700723845'],
      },
      {
        locale: 'fr-GF',
        valid: [
      ...
      {
        locale: 'es-NI',
        valid: ['+5051234567', '+50512345678', '5051234567', '50512345678', '+50555555555'],
        invalid: [
          '1234',
          '',
          '1234567',
      ...
      },
      {
        ...
        invalid: ['19023818688', '323254', '+903232323257', '++3567868', '0902381888832'],
      },
      {
        locale: 'it-IT',
      ...
      },
      {
        ...
        invalid: ['+2449111234321', '+244811123432', '31234', '31234567', '512345', 'NotANumber'],
      },
      {
        locale: 'lv-LV',
      ...
      },
      {
        ...
        invalid: ['+97888112222', '+97977112222', '+97094112222', '+97281112222', '02297681112222'],
      },
      {
        locale: 'my-MM',
        valid: [
